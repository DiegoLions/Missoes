...
//                 if (prioridade <= 0 || prioridade >= 6 || isNaN(prioridade)) {
//                     console.log('Prioridade inválida!!');
//                     return adicionarMissaoAoGerenciador();
//                 }
//                 AdicionarTripulantes(nome,destino,prioridade)
//         })
//     })
// })

//                     function AdicionarTripulantes(nome,destino,prioridade) {
//                         let tripulantes = []; 
...
function addTripulante(){
    let tripulantess = []
    rl.question("Add uim tripu ", (tripu) =>{
        tripulantess.push(tripu)
        console.log(tripulantess)
        let controle = true
        rl.question("deseja add ", (res) => {
        if(res =='s'){
            console.log(tripu)
            addTripulante()
        } else{
